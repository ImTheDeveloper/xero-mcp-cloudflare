/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 33494ca76559f2de10c650737d3ddbc5)
// Runtime types generated with workerd@1.20260317.1 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "XeroMCP" | "AuthStore";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		WORKER_BASE_URL: string;
		XERO_OAUTH_SCOPES: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").XeroMCP>;
		AUTH_STORE: DurableObjectNamespace<import("./src/index").AuthStore>;
	}
}
